...
export default function TravelPage() {
  ...
  const futureDestinations = [
    { name: "Denmark", year: "2026", highlight: "Copenhagen, Nordic design & culture" },
    { name: "Finland", year: "2026", highlight: "Helsinki, Lapland & Northern Lights" },
    { name: "Sweden", year: "2026", highlight: "Stockholm, Gothenburg & archarchipelago" },
  ]
