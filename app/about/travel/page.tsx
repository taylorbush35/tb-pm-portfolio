...
export default function TravelPage() {
  ...
  const countries = [
    ...
    },
    {
      ...
      reflection: "Design in the details, warmth in the welcome. Copenhagen slows you down in the best way.",
      size: "normal",
    ...
    },
    {
      ...
      reflection: "Silence, snow, and sky on fire. Finland feels like stepping into another world.",
      size: "normal",
      image: "/Helsinki.jpeg",
    },
    {
      name: "Sweden",
      visits: "2026",
      highlight: "Stockholm, Gothenburg & archipelago",
      reflection: "Islands and islands of light. Sweden blends edge and ease like nowhere else.",
      size: "normal",
          ...
          {countries.map((country, index) => (
            ...
            >
              ...
              <img
                ...
                alt={country.name}
                className={`absolute inset-0 size-full object-cover brightness-110 transition-all duration-500 group-hover:brightness-105 dark:opacity-80 dark:brightness-100 dark:group-hover:opacity-60 ${
                  country.name === "Sweden"
                    ? "scale-[3] [transform-origin:58%_92%] [object-position:58%_92%] group-hover:scale-[3.18]"
