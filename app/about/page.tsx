  ...
  return (
    <div className="relative min-h-screen bg-background">
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-6 py-16 sm:px-8 sm:py-20">
        ...
        <div className="relative rounded-2xl bg-muted/30 px-8 py-16 transition-all duration-500 hover:bg-muted/40 dark:bg-muted/20 dark:hover:bg-muted/30 sm:px-12 sm:py-20">
          ...
          <div className="relative grid gap-6 sm:grid-cols-3">
            ...
            <Card className="group relative h-full border-border/50 bg-background p-6 transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/10 dark:hover:shadow-primary/20">
              <div className="absolute -top-3 left-4 flex items-center gap-1.5 rounded-full bg-gradient-to-r from-accent/90 to-purple-500/90 px-3 py-1 text-xs font-medium text-white shadow-md transition-all duration-300 group-hover:scale-105 group-hover:shadow-lg">
